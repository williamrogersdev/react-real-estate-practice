      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 whitespace-nowrap">
            The First Image is the Featured Cover Image. (Max 6 Images)
          </p>
        ...
        <button
          type="submit"
          className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800"
          a
        >
          {" "}
          Create Listing
